    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h4 class="sub-header"><a class="pull-right" href="anadir_producto.php"><i class="fa fa-plus" aria-hidden="true"> Añadir Producto</i></a></h4>
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <?php
                ...
                $select = "SELECT * FROM inventario_producto";
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo $data["existencias_iniciales"]; ?></td>
                  <td><?php echo $data["compras"]; ?></td>
